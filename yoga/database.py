...
def csv_parser(name_file):
    if name_file == "csv_folder\user.csv":
        mat = [["" for j in range(3)] for i in range(103)]
    elif name_file == "csv_folder\candi.csv":
        mat = [["" for j in range(5)] for i in range(101)]
    elif name_file == "csv_folder\bahan_bangunan.csv":
...
bahan_bangunan = load("csv_folder\bahan_bangunan.csv", bahan_bangunan)
candi = load("csv_folder\candi.csv",candi)